## This is a Codebook containing the information for all the 68 variables in tidy data set "tidydata.txt" obtained by combining train and test data sets and cleaning them.
